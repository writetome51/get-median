...
try {
    var result_1 = getMedian_1.getMedian();
}
catch (e) {
    errorTriggered = true;
}
...
try {
    var result_2 = getMedian_1.getMedian([]);
}
catch (e) {
    errorTriggered = true;
}
...
try {
    var result_3 = getMedian_1.getMedian([1, 2, 3, 'e', 4, 5, 8]);
}
catch (e) {
    ++errorsTriggered;
}
try {
    var result_4 = getMedian_1.getMedian([1, 2, 3, false, 4, 5, 8]);
}
catch (e) {
    ++errorsTriggered;
}
try {
    var result_5 = getMedian_1.getMedian([1, 2, 3, 4, [], 7, 8, 9]);
}
catch (e) {
    ++errorsTriggered;
}
try {
    var result_6 = getMedian_1.getMedian([1, 2, 3, 3.5, undefined, 4, 5, 8]);
}
catch (e) {
    ++errorsTriggered;
}
try {
    var result_7 = getMedian_1.getMedian([1, 2, {}, 7, 8]);
}
catch (e) {
    ++errorsTriggered;
}
...
var result = getMedian_1.getMedian([1, 3, 5, 7, 9, 11.2, 13, 15, 17, 19, 21]);
if (result === 11.2)
    console.log('test 4 passed');
else
    console.log('test 4 failed');
// Test 5: get median accurately when array length is even:
result = getMedian_1.getMedian([1, 3, 5, 7, 9, 11, 13.3, 15, 17, 19, 21, 23]);
if (result === 12.15)
...
result = getMedian_1.getMedian(numbers);
var median = 500000;
if (result === median)
...
result = getMedian_1.getMedian([3, 8, 13, 18, 23, 28, 33, 38, 43, 48, 53, 58, 63, 68]);
median = 35.5;
if (result === median)
